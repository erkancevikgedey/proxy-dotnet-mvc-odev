...
builder.Services.AddScoped<IProxyDetailsService, ProxyDetailsService>();
builder.Services.AddScoped<IBotDetailsService, BotDetailsService>();
builder.Services.AddScoped<IMessageDetailsService, MessageDetailsService>();
